...
/**
 * Encapsulates support for the Derby database (also known as JavaDB).
 * 
...
public class DerbyEnvironment extends AbstractDbEnvironment {
	...
	protected String getConnectionString(String dataSource) {
		return "jdbc:derby://" + dataSource;
	}

	@Override
	protected String getConnectionString(String dataSource, String database) {
		return "jdbc:derby://" + dataSource + "/" + database;
	}
	...
	/**
	 * @see http://db.apache.org/derby/docs/10.4/ref/ref-single.html#crefsqlj21305
	 */
